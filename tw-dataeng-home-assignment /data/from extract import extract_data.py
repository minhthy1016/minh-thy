...
#active_date,user_id,workspace_id,total_activity
    #create table
    ...
    #create table
    query_create_table = f"CREATE TABLE IF NOT EXISTS {column_name}(\ 
    active_date String(32767),\
	user_id String(32767) PRIMARY KEY,\
	workspace_id String(32767),\
	total_activity String(32767)\
    {column_name} decimal\
    );"
